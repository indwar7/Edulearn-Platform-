...
.feat-foot__inner{max-width:1600px;margin:0 auto;padding:24px 40px;border-top:1px solid rgba(15,23,42,.12);font-family:'Fragment Mono',monospace;font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:#5B6472;}
